...
payload = {
    ...
    "graph": {
        "nodes": {
            "node_1": {"id": "node_1", "type": "api", "capacity_rps": 1000, "base_latency_ms": 10, "replicas": 5, "queue_size": 1000},
            "node_2": {"id": "node_2", "type": "db", "capacity_rps": 200, "base_latency_ms": 50, "replicas": 2, "queue_size": 1000}
        },
        "edges": [
